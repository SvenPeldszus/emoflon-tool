...
public class InternalInjectionLanguageLexer extends Lexer {
    ...
    public final void mRULE_BLOCK_BEGIN() throws RecognitionException {
        try {
            // InternalInjectionLanguage.g:1685:27: ( '<--' )
            // InternalInjectionLanguage.g:1685:29: '<--'
            {
            match("<--"); 
    ...
    public final void mRULE_BLOCK_END() throws RecognitionException {
        try {
            // InternalInjectionLanguage.g:1687:25: ( '-->' )
            // InternalInjectionLanguage.g:1687:27: '-->'
            {
            match("-->"); 
    ...
    public final void mRULE_CODE_BLOCK() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalInjectionLanguage.g:1689:17: ( RULE_BLOCK_BEGIN ( . )* RULE_BLOCK_END )
            // InternalInjectionLanguage.g:1689:19: RULE_BLOCK_BEGIN ( . )* RULE_BLOCK_END
            {
            mRULE_BLOCK_BEGIN(); 
            // InternalInjectionLanguage.g:1689:36: ( . )*
            loop1:
            do {
                int alt1=2;
    ...
    public final void mRULE_ID() throws RecognitionException {
        try {
            int _type = RULE_ID;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalInjectionLanguage.g:1691:9: ( ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )* )
            // InternalInjectionLanguage.g:1691:11: ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            {
            // InternalInjectionLanguage.g:1691:11: ( '^' )?
            int alt2=2;
            ...
            // InternalInjectionLanguage.g:1691:40: ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            loop3:
            do {
                int alt3=2;
    ...
    public final void mRULE_INT() throws RecognitionException {
        try {
            int _type = RULE_INT;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalInjectionLanguage.g:1693:10: ( ( '0' .. '9' )+ )
            // InternalInjectionLanguage.g:1693:12: ( '0' .. '9' )+
            {
            // InternalInjectionLanguage.g:1693:12: ( '0' .. '9' )+
            int cnt4=0;
            loop4:
            do {
                ...
                switch (alt4) {
            	case 1 :
            	    // InternalInjectionLanguage.g:1693:13: '0' .. '9'
            	    {
            	    matchRange('0','9'); 
    ...
    public final void mRULE_STRING() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalInjectionLanguage.g:1695:13: ( ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' ) )
            // InternalInjectionLanguage.g:1695:15: ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' )
            {
            // InternalInjectionLanguage.g:1695:15: ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' )
            int alt7=2;
            ...
            switch (alt7) {
                case 1 :
                    // InternalInjectionLanguage.g:1695:16: '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"'
                    {
                    match('\"'); 
                    // InternalInjectionLanguage.g:1695:20: ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )*
                    loop5:
                    do {
                        int alt5=3;
                        ...
                        switch (alt5) {
                    	case 1 :
                    	    // InternalInjectionLanguage.g:1695:21: '\\\\' .
                    	    {
                    	    match('\\'); 
                    	    matchAny(); 
                    	    ...
                    	    break;
                    	case 2 :
                    	    // InternalInjectionLanguage.g:1695:28: ~ ( ( '\\\\' | '\"' ) )
                    	    {
                    ...
                    break;
                case 2 :
                    // InternalInjectionLanguage.g:1695:48: '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\''
                    {
                    match('\''); 
                    // InternalInjectionLanguage.g:1695:53: ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )*
                    loop6:
                    do {
                        int alt6=3;
                        ...
                        switch (alt6) {
                    	case 1 :
                    	    // InternalInjectionLanguage.g:1695:54: '\\\\' .
                    	    {
                    	    match('\\'); 
                    	    matchAny(); 
                    	    ...
                    	    break;
                    	case 2 :
                    	    // InternalInjectionLanguage.g:1695:61: ~ ( ( '\\\\' | '\\'' ) )
                    	    {
                    	    if ( (input.LA(1)>='\u0000' && input.LA(1)<='&')||(input.LA(1)>='(' && input.LA(1)<='[')||(input.LA(1)>=']' && input.LA(1)<='\uFFFF') ) {
                    	        input.consume();
    ...
    public final void mRULE_ML_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalInjectionLanguage.g:1697:17: ( '/*' ( options {greedy=false; } : . )* '*/' )
            // InternalInjectionLanguage.g:1697:19: '/*' ( options {greedy=false; } : . )* '*/'
            {
            match("/*"); 

            // InternalInjectionLanguage.g:1697:24: ( options {greedy=false; } : . )*
            loop8:
            do {
                int alt8=2;
                ...
                switch (alt8) {
            	case 1 :
            	    // InternalInjectionLanguage.g:1697:52: .
            	    {
            	    matchAny(); 
    ...
    public final void mRULE_SL_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalInjectionLanguage.g:1699:17: ( '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )? )
            // InternalInjectionLanguage.g:1699:19: '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )?
            {
            match("//"); 

            // InternalInjectionLanguage.g:1699:24: (~ ( ( '\\n' | '\\r' ) ) )*
            loop9:
            do {
                int alt9=2;
            ...
            // InternalInjectionLanguage.g:1699:40: ( ( '\\r' )? '\\n' )?
            int alt11=2;
            ...
            switch (alt11) {
                case 1 :
                    // InternalInjectionLanguage.g:1699:41: ( '\\r' )? '\\n'
                    {
                    // InternalInjectionLanguage.g:1699:41: ( '\\r' )?
                    int alt10=2;
    ...
    public final void mRULE_WS() throws RecognitionException {
        try {
            int _type = RULE_WS;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalInjectionLanguage.g:1701:9: ( ( ' ' | '\\t' | '\\r' | '\\n' )+ )
            // InternalInjectionLanguage.g:1701:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            {
            // InternalInjectionLanguage.g:1701:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            int cnt12=0;
            loop12:
    ...
    public final void mRULE_ANY_OTHER() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalInjectionLanguage.g:1703:16: ( . )
            // InternalInjectionLanguage.g:1703:18: .
            {
            matchAny(); 
