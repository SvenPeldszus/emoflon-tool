...
public class InjectionLanguageValidatorConfigurationBlock extends AbstractValidatorConfigurationBlock {

	@Override
	protected void fillSettingsPage(Composite composite, int nColumns, int defaultIndent) {
		addComboBox(InjectionLanguageConfigurableIssueCodesProvider.DEPRECATED_MODEL_PART, "Deprecated Model Part", composite, defaultIndent);
	}
	...
	protected IDialogSettings getDialogSettings() {
		...
		IDialogSettings section = dialogSettings.getSection("InjectionLanguage");
		if (section == null) {
			return dialogSettings.addNewSection("InjectionLanguage");
		}
		return section;
	}
}
